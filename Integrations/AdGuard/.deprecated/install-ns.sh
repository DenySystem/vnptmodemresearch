...
echo ""
echo -e "Nếu chưa biết là gì có thể đọc ở tại:${BLUE} https://github.com/DenySystem/vnptmodemresearch/blob/main/Integrations/AdGuard/README.md ${RESET}"
echo ""
...
/userfs/bin/curl -s -k -o AdGuard.sh https://raw.githubusercontent.com/DenySystem/vnptmodemresearch/refs/heads/main/Integrations/AdGuard/startup.sh
chmod +x AdGuard.sh
