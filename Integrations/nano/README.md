...
* Đã cài patch [myshell](https://github.com/DenySystem/vnptmodemresearch/blob/master/Integrations/myshell/README.md)
...
```sh
cd /tmp && /userfs/bin/curl -s -k -o install-nano.sh https://raw.githubusercontent.com/DenySystem/vnptmodemresearch/refs/heads/master/Integrations/nano/install.sh && chmod +x install-nano.sh && sh install-nano.sh
```
