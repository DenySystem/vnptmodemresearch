...
<h6 align="left">DenySystem, D:13/M:01/Y:2026</h6>
...
```sh
cd /tmp/ && /userfs/bin/curl -s -k -o autorun.sh https://raw.githubusercontent.com/DenySystem/vnptmodemresearch/refs/heads/master/Integrations/autorun/patch.sh && chmod +x autorun.sh && sh autorun.sh
```
