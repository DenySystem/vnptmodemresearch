...
# myshell.sh
# Copyright © 2025-2026 DenySystem, collaborators and contributors.
#
...
if [ ! -f /userfs/bin/dropbear ]; then
    ...
    echo -e "${GREEN}https://github.com/DenySystem/vnptmodemresearch/tree/master/Integrations/myshell#1-y%C3%AAu-c%E1%BA%A7u${RESET}"
    echo -e "\n\n"
    exit 1
fi
# show text
...
echo -e "${RED}############################################################\n"
echo -e "${GREEN} https://github.com/DenySystem/vnptmodemresearch\n"
echo -e "${RED}############################################################\n"
...
mkdir -p myshell
mkdir -p program
cd program && mkdir config && cd ..
cd myshell
/userfs/bin/curl -s -k -o config.sh https://raw.githubusercontent.com/DenySystem/vnptmodemresearch/refs/heads/master/Integrations/myshell/config.sh && chmod +x config.sh
/userfs/bin/curl -s -k -o startup.sh https://raw.githubusercontent.com/DenySystem/vnptmodemresearch/refs/heads/master/Integrations/myshell/startup.sh && chmod +x startup.sh
/userfs/bin/curl -s -k -o banner.txt https://raw.githubusercontent.com/DenySystem/vnptmodemresearch/refs/heads/master/Integrations/myshell/banner.txt
