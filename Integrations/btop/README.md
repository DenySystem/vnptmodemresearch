...
```sh
cd /tmp && /userfs/bin/curl -s -k -o install-btop.sh https://raw.githubusercontent.com/DenySystem/vnptmodemresearch/refs/heads/master/Integrations/btop/install.sh && chmod +x install-btop.sh && sh install-btop.sh
```
