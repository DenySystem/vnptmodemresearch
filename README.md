...
---
## 2: <ins>Content</ins>
* [`flashdump/*`](https://github.com/DenySystem/vnptmodemresearch/tree/master/flashdump) NAND dump của firmware model GW-020H (sắp tới sẽ cập nhật thêm -XS, -NS)
* [`openwrt-initramfs-en751221/*`](https://github.com/DenySystem/vnptmodemresearch/tree/master/openwrt-initramfs-en751221) dùng để debrick nếu vọc vạch cháy firmware
* [`openwrt-xsw-050ns/*`](https://github.com/DenySystem/vnptmodemresearch/tree/master/openwrt-xsw-050ns) OpenWRT cho XSW050-NS (cảm ơn [@longnt2007](https://github.com/longnt2007) với đóng góp của bạn :3)
* [`tools/*`](https://github.com/DenySystem/vnptmodemresearch/tree/master/tools) các tool để decrypt và encrypt romfile.cfg
* Sắp tới sẽ cập nhật tool encrypt, decrypt cho dòng -XS (050)
* [`decrypted-cfgfile-xs/*`](https://github.com/DenySystem/vnptmodemresearch/tree/master/decrypted-cfgfile-xs) các mẫu file romfile.cfg của model đã decrypt
*  [`private-romfile-key/*`](https://github.com/DenySystem/vnptmodemresearch/tree/master/private-romfile-key) cert và private key cho decrypt và encrypt file .cfg model -XS
* Dump firmware đã được strip trong [`squashfs-modified`](https://github.com/DenySystem/vnptmodemresearch/tree/master/squashfs-modified):
	...
	* squashfs-root(đã giải mã) tại [đây](https://github.com/DenySystem/vnptmodemresearch/releases)
 *  [`Integrations/*`](https://github.com/DenySystem/vnptmodemresearch/tree/master/Integrations) Hướng dẫn và tài nguyên, lệnh cài các phần mềm bổ sung, patch,...
---
...
* [Mở vỏ router](https://github.com/DenySystem/vnptmodemresearch/tree/master/doc/disassemble) ra để thấy bo mạch
...
Và quay lại [đây](https://github.com/DenySystem/vnptmodemresearch/blob/master/README.md#32-t%C3%A0i-kho%E1%BA%A3n-login) để đăng nhập vào shell  
...
* (Cho dòng -XGS) Hãy tham khảo bản OpenWrt build bởi [@longnt2007](https://github.com/DenySystem/openwrt-xsw050ns)
 ...
 * Cảm ơn [@cjdelisle](https://github.com/cjdelisle) cho bản [initramfs](https://github.com/DenySystem/vnptmodemresearch/blob/master/openwrt-initramfs-en751221/openwrt-econet-en751221-en751221_generic-initramfs-kernel.bin)!
...
> [!DEP]  
> Hiện đã có repo và tool riêng cho việc trích xuất và chỉnh sửa firmware stock, vui lòng tham khảo tại [đây](https://github.com/DenySystem/gw040ns-firmware)
...
---
## 8: <ins>Ứng dụng</ins>
* [AdGuardHome](https://github.com/DenySystem/vnptmodemresearch/tree/master/Integrations/AdGuard)
* [ddns-updater](https://github.com/DenySystem/vnptmodemresearch/tree/master/Integrations/ddns_updater)
* Caddy (In progress)
* wolweb (In progress)
* [Btop](https://github.com/DenySystem/vnptmodemresearch/tree/master/Integrations/btop)
* [nano](https://github.com/DenySystem/vnptmodemresearch/tree/master/Integrations/nano)
> Đã có hướng dẫn cài trong README của các phần ứng dụng
---
## 9: Patch ( Với các dòng NS )
* [autorun](https://github.com/DenySystem/vnptmodemresearch/tree/master/Integrations/autorun)
* [myshell](https://github.com/DenySystem/vnptmodemresearch/tree/master/Integrations/myshell) 
---
...
* [Github](https://github.com/DenySystem/vnptmodemresearch/discussions/10)
* ~~Discord~~
---
...
* Custom được firmware để dễ dàng phát triển hơn (Như custom Web-UI, thêm bớt tính năng, tối ưu hiệu năng)
  * Đã release ngay tại [đây](https://github.com/DenySystem/gw040ns-firmware)
## Cập nhật
* Em đã làm 1 web online để có thể tự giải mã và mã hoá file mà không cần các bác phải cài này nọ tại [đây](https://huggingface.co/spaces/DenySystem/file-decoder)
...
<p align="center">Made with ❤️ by DenySystem</p>
