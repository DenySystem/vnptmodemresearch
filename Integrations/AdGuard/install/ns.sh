...
/userfs/bin/curl -s -k -o ca.crt https://raw.githubusercontent.com/DenySystem/vnptmodemresearch/refs/heads/master/Integrations/AdGuard/accvraiz1.crt
export SSL_CERT_FILE=/tmp/userdata/AdGuard/ca.crt
echo -e "${GREEN}[OK]${RESET} Downloaded certificate."
/userfs/bin/curl -s -k -o startup.sh https://raw.githubusercontent.com/DenySystem/vnptmodemresearch/refs/heads/master/Integrations/AdGuard/startup.sh && chmod +x startup.sh
